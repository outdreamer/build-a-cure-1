...
To do:
	...
	- show how to convert solution automation method to core functions:
			find, apply, transform, identity, build, match)
		& objects:
			structures (layer, limit, origin, gap), framework (interface/filter)
		which is also a method to generate all solution automation methods
