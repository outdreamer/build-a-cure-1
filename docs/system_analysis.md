...
insight path:
	...
	- the insight path can be represented as:
		- a pattern/function
		- including: 
			- the set of operation functions (or their dependencies/identity source objects/attributes/types/alternative vars/functions/core functions)
			- the set of inputs vars values (or their dependencies/identity source objects/attributes/types/alternative vars/functions/core functions)
			- the set of outputs vars values (or their dependencies/identity source objects/attributes/types/alternative vars/functions/core functions)
	...
	- Example:
		...
		doctor(patient.symptom_info) patient   		drug
			   								drug.molecule.share_electron(patient.electrons)
		...
		The insight paths might be:
			- "doctor ask patient to get info"
			- "x ask y to get info"
			...
			- "doctor ask assistant to get info"
				("assistant" is a dependency of "patient" bc the patient becomes relevant to the doctor bc of the "assistant")
