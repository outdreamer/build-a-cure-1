...
# Structural Objects
  ...
  pattern alts:
  - missing options:  'JJ of JJR NNPS', for 'all_n all_n of all_n all_n'
  - in list b***in list b, = ADV V |V N| in output patterns
  - repeated options shouldnt happen within an alt set: |NNS NNS VBZ2 VBZ3 NNS| 
  - missing repeated indexes: |suppose thought1 assumed| that3 DPC |suppose thought6 assumed| that8 ALL_N9 ALL_N10 ALL_N11
