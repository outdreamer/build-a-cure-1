  ...
  ### 
    ...
    - but you could also generate a function programmatically:
      - to generate a function that classifies an object by an attribute (object=attribute, attribute=type), query definitions of those
        ...
        - filter is a core function

    - also generate which attributes coordinate with which rule sets
      ...
      - example:
        ...
        - given the set of all possible moves (and resulting paths), you should be able to calculate emerging attributes of the game of chess
          - such as:
            ...
            - optimal intent & intent combinations (diversify, get to opposing end first, guard king)
